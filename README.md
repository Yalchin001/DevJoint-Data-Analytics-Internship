...
* Importing and preparing multiple CSV datasets
* Fact and dimension table modeling
* One-to-many relationships and filter direction
* DAX measures and time-based calculations
* Actual Sales vs Sales Target analysis
* Previous-year and YoY performance comparison
* KPI summary cards

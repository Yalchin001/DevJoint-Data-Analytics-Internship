...
| 3 | Power BI Dashboard | Data model, DAX measures, KPIs, and interactive dashboard | 🔄 In Progress |
...
- `LEFT JOIN`, `INNER JOIN`, and self-joins
...
- Data cleaning and data type validation
- `XLOOKUP`, `VLOOKUP`, `INDEX`, and `MATCH`
- `SUMIFS`, `COUNTIFS`, `IF`, and `IFS`
...
The SQL and Excel modules have been completed and documented. I am currently working on the Power BI dashboard module.
